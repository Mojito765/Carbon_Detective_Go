...
public class dialog8_fragment extends DialogFragment {

    public dialog8_fragment() {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        View view = requireActivity().getLayoutInflater().inflate(R.layout.about_us_dialog, new LinearLayout(getActivity()), false);
        // Build dialog
